...
namespace PathProjectChallenge.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new PathException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new PathException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new PathException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        /// </summary>
        public static IPathFileProvider DefaultFileProvider { get; set; }
