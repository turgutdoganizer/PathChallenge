...
namespace PathProjectChallenge.Core.Configuration
{
    /// <summary>
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, IPathFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(PathConfigurationDefaults.AppSettingsFilePath);
