...
namespace PathProjectChallenge.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class PathEngine : IEngine
    {
        #region Utilities
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = Singleton<ITypeFinder>.Instance;
            var startupConfigurations = typeFinder.FindClassesOfType<IPathStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IPathStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new PathException("Unknown dependency");
                        return service;
                    });
            ...
            throw new PathException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
