...
namespace PathProjectChallenge.Infrastructure.Plugins
{
    ...
    public partial class PluginsInfo : IPluginsInfo
    {
        ...
        protected readonly IPathFileProvider _fileProvider;
        ...
        public PluginsInfo(IPathFileProvider fileProvider)
        {
        ...
        public virtual void LoadPluginInfo()
        {
            ...
            foreach (var item in GetDescriptionFilesAndDescriptors(pluginsDirectory))
            {
                ...
                if (!pluginDescriptor.SupportedVersions.Contains(PathVersion.CURRENT_VERSION, StringComparer.InvariantCultureIgnoreCase))
                {
