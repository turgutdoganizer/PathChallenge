...
namespace PathProjectChallenge.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(IPathFileProvider fileProvider = null, bool reload = false)
        {
            ...
            var filePath_json = fileProvider.MapPath(DataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(DataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, IPathFileProvider fileProvider)
        {
            AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
