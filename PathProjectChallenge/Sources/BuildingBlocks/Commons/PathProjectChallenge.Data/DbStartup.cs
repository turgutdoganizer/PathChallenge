...
namespace PathProjectChallenge.Data
{
    ...
    /// </summary>
    public partial class DbStartup : IPathStartup
    {
        /// <summary>
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services
                ...
                .AddScoped<IProcessorAccessor, PathProcessorAccessor>()
                ...
                .AddSingleton<IConventionSet, PathConventionSet>()
            ...
            foreach (var assembly in mAssemblies)
                runner.ApplyUpMigrations(assembly, MigrationProcessType.Installation);
        }
