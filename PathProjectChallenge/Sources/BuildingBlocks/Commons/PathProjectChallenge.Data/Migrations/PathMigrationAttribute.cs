...
namespace PathProjectChallenge.Data.Migrations
{
    ...
    /// </summary>
    public partial class PathMigrationAttribute : MigrationAttribute
    {
        #region Utils

        protected static long GetVersion(string dateTime)
        {
            return DateTime.ParseExact(dateTime, PathMigrationDefaults.DateFormats, CultureInfo.InvariantCulture).Ticks;
        }
        ...
        {
            return string.Format(PathMigrationDefaults.UpdateMigrationDescription, nopVersion, migrationType.ToString());
        }
        ...
        public PathMigrationAttribute(string dateTime, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        ...
        /// <param name="targetMigrationProcess">The target migration process</param>
        public PathMigrationAttribute(string dateTime, string description, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        ...
        /// <param name="targetMigrationProcess">The target migration process</param>
        public PathMigrationAttribute(string dateTime, string nopVersion, UpdateMigrationType migrationType, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
