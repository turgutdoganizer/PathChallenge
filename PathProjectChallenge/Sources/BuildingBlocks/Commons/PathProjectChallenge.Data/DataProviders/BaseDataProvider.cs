...
using PathProjectChallenge.Data.DataProviders.Interceptors;
...
namespace PathProjectChallenge.Data.DataProviders
{
    public abstract partial class BaseDataProvider : IMappingEntityAccessor
    {
        ...
        protected static ConcurrentDictionary<Type, PathEntityDescriptor> EntityDescriptors { get; } = new ConcurrentDictionary<Type, PathEntityDescriptor>();
        ...
        public virtual void InitializeDatabase()
        {
            ...
            var targetAssembly = typeof(DbStartup).Assembly;
        ...
        public virtual PathEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new Mapping.PathEntityDescriptor
                {
