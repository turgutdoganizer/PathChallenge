...
using PathProjectChallenge.Core.ComponentModel;
...
namespace Catalog.Service.Infrastructure.Extensions
{
    ...
    public static partial class ApplicationPartManagerExtensions
    {
        ...
        private static readonly IPathFileProvider _fileProvider;
        ...
        private static Assembly PerformFileDeploy(this ApplicationPartManager applicationPartManager,
            string assemblyFile, PluginConfig pluginConfig, IPathFileProvider fileProvider)
        {
